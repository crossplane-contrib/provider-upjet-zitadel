...
type PolicyInitParameters struct {
	...
	IdpGoogleRefs []v1.NamespacedReference `json:"idpGoogleRefs,omitempty" tf:"-"`

	// Selector for a list of IdpGoogle in org to populate idps.
	// +kubebuilder:validation:Optional
	IdpGoogleSelector *v1.NamespacedSelector `json:"idpGoogleSelector,omitempty" tf:"-"`

	// (Set of String) allowed idps to login or register
	// allowed idps to login or register
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-zitadel/apis/namespaced/org/v1alpha1.IdpGoogle
