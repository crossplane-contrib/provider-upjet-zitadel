...
type AzureAdSpec struct {
	...
	// autoscaler.
	InitProvider AzureAdInitParameters `json:"initProvider,omitempty"`
}
...
// AzureAd is the Schema for the AzureAds API. Resource representing an Azure AD IDP on the instance.
