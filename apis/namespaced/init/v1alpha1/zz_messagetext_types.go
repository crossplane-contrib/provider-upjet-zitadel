...
type MessageTextInitParameters struct {
...
type MessageTextObservation struct {
...
type MessageTextSpec struct {
	...
	ForProvider            MessageTextParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MessageTextInitParameters `json:"initProvider,omitempty"`
}

// MessageTextStatus defines the observed state of MessageText.
type MessageTextStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MessageTextObservation `json:"atProvider,omitempty"`
}
...
// MessageTextList contains a list of MessageTexts
...
var (
	MessageText_Kind             = "MessageText"
	MessageText_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MessageText_Kind}.String()
	MessageText_KindAPIVersion   = MessageText_Kind + "." + CRDGroupVersion.String()
	MessageText_GroupVersionKind = CRDGroupVersion.WithKind(MessageText_Kind)
)

func init() {
	SchemeBuilder.Register(&MessageText{}, &MessageTextList{})
}
