...
type IdpOidcInitParameters struct {
	...
	// (String) the OIDC issuer of the identity provider
...
// IdpOidc is the Schema for the IdpOidcs API. Resource representing a generic OIDC IdP on the organization.
