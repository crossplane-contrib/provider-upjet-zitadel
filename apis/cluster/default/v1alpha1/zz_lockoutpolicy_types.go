...
type LockoutPolicyInitParameters struct {
	...
	// (Number) Maximum OTP check attempts before the account gets locked. Attempts are reset as soon as the OTP is entered correctly.
...
// LockoutPolicy is the Schema for the LockoutPolicys API. Resource representing the default lockout policy.
