...
type IdpLdapInitParameters struct {
	...
	// signed certificates for TLS connections to LDAP servers. It is intended to be filled with the contents of a .pem file.
	...
	RootCA *string `json:"rootCa,omitempty" tf:"root_ca,omitempty"`
...
// IdpLdap is the Schema for the IdpLdaps API. Resource representing an LDAP IdP on the organization.
