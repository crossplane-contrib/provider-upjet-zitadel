...
type IdpAppleInitParameters struct {
...
type IdpAppleObservation struct {
...
// IdpAppleSpec defines the desired state of IdpApple
type IdpAppleSpec struct {
	...
	// autoscaler.
	InitProvider IdpAppleInitParameters `json:"initProvider,omitempty"`
}

// IdpAppleStatus defines the observed state of IdpApple.
...
// IdpApple is the Schema for the IdpApples API. Resource representing an Apple IDP on the organization.
...
// IdpAppleList contains a list of IdpApples
...
var (
	IdpApple_Kind             = "IdpApple"
	IdpApple_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpApple_Kind}.String()
	IdpApple_KindAPIVersion   = IdpApple_Kind + "." + CRDGroupVersion.String()
	IdpApple_GroupVersionKind = CRDGroupVersion.WithKind(IdpApple_Kind)
)
