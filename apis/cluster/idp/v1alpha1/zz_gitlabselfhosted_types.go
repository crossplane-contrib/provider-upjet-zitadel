...
type GitlabSelfHostedInitParameters struct {
...
type GitlabSelfHostedObservation struct {
...
type GitlabSelfHostedParameters struct {
...
// GitlabSelfHostedSpec defines the desired state of GitlabSelfHosted
type GitlabSelfHostedSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GitlabSelfHostedParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GitlabSelfHostedInitParameters `json:"initProvider,omitempty"`
}

// GitlabSelfHostedStatus defines the observed state of GitlabSelfHosted.
type GitlabSelfHostedStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GitlabSelfHostedObservation `json:"atProvider,omitempty"`
}
...
// GitlabSelfHosted is the Schema for the GitlabSelfHosteds API. Resource representing a GitLab Self Hosted IDP on the instance.
...
type GitlabSelfHosted struct {
	...
	Spec   GitlabSelfHostedSpec   `json:"spec"`
	Status GitlabSelfHostedStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GitlabSelfHostedList contains a list of GitlabSelfHosteds
type GitlabSelfHostedList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GitlabSelfHosted `json:"items"`
}

// Repository type metadata.
var (
	GitlabSelfHosted_Kind             = "GitlabSelfHosted"
	GitlabSelfHosted_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GitlabSelfHosted_Kind}.String()
	GitlabSelfHosted_KindAPIVersion   = GitlabSelfHosted_Kind + "." + CRDGroupVersion.String()
	GitlabSelfHosted_GroupVersionKind = CRDGroupVersion.WithKind(GitlabSelfHosted_Kind)
)

func init() {
	SchemeBuilder.Register(&GitlabSelfHosted{}, &GitlabSelfHostedList{})
}
