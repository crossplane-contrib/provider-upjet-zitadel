...
type GithubEsInitParameters struct {
...
type GithubEsObservation struct {
...
type GithubEsParameters struct {
...
// GithubEsSpec defines the desired state of GithubEs
type GithubEsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GithubEsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GithubEsInitParameters `json:"initProvider,omitempty"`
}

// GithubEsStatus defines the observed state of GithubEs.
type GithubEsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GithubEsObservation `json:"atProvider,omitempty"`
}
...
// GithubEs is the Schema for the GithubEss API. Resource representing a GitHub Enterprise IDP on the instance.
...
type GithubEs struct {
	...
	Spec   GithubEsSpec   `json:"spec"`
	Status GithubEsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GithubEsList contains a list of GithubEss
type GithubEsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GithubEs `json:"items"`
}

// Repository type metadata.
var (
	GithubEs_Kind             = "GithubEs"
	GithubEs_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GithubEs_Kind}.String()
	GithubEs_KindAPIVersion   = GithubEs_Kind + "." + CRDGroupVersion.String()
	GithubEs_GroupVersionKind = CRDGroupVersion.WithKind(GithubEs_Kind)
)

func init() {
	SchemeBuilder.Register(&GithubEs{}, &GithubEsList{})
}
