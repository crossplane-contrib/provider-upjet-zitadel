...
func (tr *AzureAd) GetObservation() (map[string]any, error) {
...
func (tr *AzureAd) SetObservation(obs map[string]any) error {
...
func (tr *AzureAd) GetParameters() (map[string]any, error) {
...
func (tr *AzureAd) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AzureAd
func (tr *AzureAd) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AzureAd
func (tr *AzureAd) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
