...
type HumanUserInitParameters struct {
	...
	InitialHashedPasswordSecretRef *v1.SecretKeySelector `json:"initialHashedPasswordSecretRef,omitempty" tf:"-"`
	...
	TotpSecretSecretRef *v1.SecretKeySelector `json:"totpSecretSecretRef,omitempty" tf:"-"`
