...
// Package main is the entry point for the Zitadel provider.
package main
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-upjet-zitadel"))
	if *debug {
		ctrl.SetLogger(zl)
	}
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-upjet-zitadel",
